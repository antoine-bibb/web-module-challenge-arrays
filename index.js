...
function is31Flavors(arr, string){
    var originalFlavors = ["Banana Nut Fudge",
    "Black Walnut",
    "Burgundy Cherry",
   "Butterscotch Ribbon",
...
function addFlavor(arr,string){originalFlavors.unshift('rainbowsherbert');
...
function removeLastFlavor(string,arr){originalFlavors.pop();
console.log(originalFlavors);
...
function getFlavorByIndex(string, arr){originalFlavors
...
function removeFlavorByName(string, arr){originalFlavors.splice(16, 30, 31);
console.log(originalFlavors)
